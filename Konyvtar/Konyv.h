...
public:
    ...
    void print()const;
    Regeny& operator=(const Regeny& r);
    ~Regeny(){};
};
...
public:
    ...
    void print()const;
    Ismeret& operator=(const Ismeret& i);
    ~Ismeret(){};
};
...
public:
    ...
    void print()const;
    Verses& operator=(const Verses& v);
    ~Verses(){};
};
...
public:
    ...
    void print()const;
    Korhataros& operator=(const Korhataros& k);
    ~Korhataros(){};
};
...
public:
    ...
    void print()const;
    Kepesism& operator=(const Kepesism& i);
    ~Kepesism(){};
};
