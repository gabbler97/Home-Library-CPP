...
Polc & Menu::add(int tipus,Polc &p){
    if(tipus==1){
        ...
        cout << "Kiadas eve:"; cin >> ev; cout << endl;
        cout << "Oldalszam:"; cin >> oldalszam; cout << endl;
        ...
        cout << "Szerzo:"; getline(cin, szerzo); cout << endl;
        cout << "Kolcsonben van?:";getline(cin, kolcson); cout << endl;
        cout << "Versek szama:"; cin>> versszam; cout << endl;
        cout << "Kiadas eve:"; cin >> ev; cout << endl;
        if(kolcson=="i" || kolcson=="igen") kolcsonben=true;
        ...
        cout << "Kiadas eve:"; cin >> ev; cout << endl;
        cout << "Oldalszam:"; cin >> oldalszam; cout << endl;
        cout << "Korhatar:"; cin >> korhatar; cout << endl;
        if(kolcson=="i" || kolcson=="igen") kolcsonben=true;
